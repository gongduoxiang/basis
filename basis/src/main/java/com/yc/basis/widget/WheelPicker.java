...
public class WheelPicker<T> extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_itemTextSize,
                getResources().getDimensionPixelSize(R.dimen.size_14));
        ...
        mSelectedItemTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_selectedTextSize,
                getResources().getDimensionPixelSize(R.dimen.size_17));
        ...
        mCurtainBorderColor = a.getColor(R.styleable.WheelPicker_wheelCurtainBorderColor, Color.WHITE);
...
//            String drawText = mDataFormat == null ? data.toString() : mDataFormat.format(data);
            String drawText = mDataList.get(position).toString();
            //在中间位置的Item作为被选中的。

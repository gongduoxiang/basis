...
public class DatePicker extends LinearLayout implements YearPicker.OnYearSelectedListener,
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.layout_basis_date, this);
        initChild();
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int textSize = a.getDimensionPixelSize(R.styleable.DatePicker_itemTextSize,
                getResources().getDimensionPixelSize(R.dimen.size_13));
        ...
        boolean isShowCurtain = a.getBoolean(R.styleable.DatePicker_wheelCurtain, true);//中间item是否显示背景
        int curtainColor = a.getColor(R.styleable.DatePicker_wheelCurtainColor, getResources().getColor(R.color.color_D3D3D3));//背景的颜色
    ...
    public int getTextMaxHeight() {
        return mYearPicker.getTextMaxHeight();
    }
